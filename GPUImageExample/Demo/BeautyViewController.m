...
- (void)viewDidLoad {
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        // ...
//        id dilationFilter = [[GPUImageJoggleFilter alloc] init];
//        GPUImageCannyEdgeDetectionFilter *canny = [GPUImageCannyEdgeDetectionFilter new];
//        _filters = @[dilationFilter, self.clrFilter, [[GPUImageDilationFilter alloc] initWithRadius:4]];
...
//    if ( _currentFilter == self.clrFilter ) {
//        displayLink = [CADisplayLink displayLinkWithTarget:self selector:@selector(refreshDisp:)];
